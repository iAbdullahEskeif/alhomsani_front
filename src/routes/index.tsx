...
import { Product, Profile } from "@/types/interfaces";
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const data: Product[] = await vehiclesResponse.json();
                                ...
                                >
                                    <div className="relative overflow-hidden">
                                        ...
                                        <div className="absolute top-2 right-2 flex gap-1">
                                            ...
                                            >
                                                <Heart
                                                    className={`size-4 ${favorites.includes(vehicle.id)
                                            ...
                                            >
                                                <Bookmark
                                                    className={`size-4 ${bookmarks.includes(vehicle.id)
                                                            ? "fill-amber-400 text-amber-400"
                                                            : "text-zinc-400"
                                                        }`}
                                                />
